...
**▸ Airbnb Finance Assistant — Reconciliación Financiera con IA**

App web full stack para reconciliar reportes de Airbnb contra estados de cuenta BBVA México. Soporta múltiples propiedades, genera reportes Excel y PDF, y opcionalmente integra análisis IA con Claude (Anthropic).

`Node.js` `Express` `PostgreSQL` `JWT` `ExcelJS` `PDFKit` `Claude API` `Railway`

[![Demo](https://img.shields.io/badge/Demo%20en%20vivo-000000?style=flat-square&logo=railway&logoColor=white)](https://airbnb-finance-assistant-production.up.railway.app)
[![Repo](https://img.shields.io/badge/GitHub-181717?style=flat-square&logo=github&logoColor=white)](https://github.com/Alfredosullivan/airbnb-finance-assistant)
...
- MS SQL Server · CI/CD · ASP.NET Core
